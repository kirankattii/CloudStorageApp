...
import ShareInput, { FileDetails } from "./ActionsModalContent"
    ...
    return (
      <DialogContent className="shad-dialog button">
        <DialogHeader className="flex flex-col gap-3">
          ...
          {
            value === "delete" && <p className="delete-confirmation">Are you sure you want to delete this file{""}
            <span className="delete-file-name">{file.name}</span>?
            </p>
          }

        </DialogHeader>
        {["rename", "share", "delete",].includes(value) && <DialogFooter className="flex flex-col gap-3 md:flex-row">
